...
fib: ## Test Fibonacci
	go test -v ./05_fibonacci/...

stack: ## Test Stack
	go test -v ./06_stack/...

roman: ## Test Roman Numerals
	go test -v ./07_romannumerals/...

prime: ## Test Prime Factors
	go test -v ./08_primefactors/...

tic: ## Test Tic Tac Toe (basic)
	go test -v ./09_tictactoe/...

yahtzee: ## Test Yahtzee
	go test -v ./10_yahtzee/...

mars: ## Test Mars Rover
	go test -v ./11_marsrover/...

tennis: ## Test Tennis
	go test -v ./12_tennis/...

rose: ## Test Gilded Rose
	go test -v ./13_gildedrose/...

golf: ## Test all Refactoring Golf holes
	go test -v ./14_refactoringgolf/...

smelly: ## Test Smelly Tic Tac Toe
	go test -v ./15_smellytictactoe/...

copier: ## Test Character Copier
	go test -v ./16_charactercopier/...

tac: ## Test Tic Tac Toe (with output)
	go test -v ./17_tictactoe/...

esa: ## Test ESA Mars Rover
	go test -v ./18_esamarsrover/...

cart: ## Test Shopping Cart
	go test -v ./19_shoppingcart/...
...
smellycart: ## Test Smelly Shopping Cart
...
golf1:
	go test -v ./14_refactoringgolf/hole1/...

golf2:
	go test -v ./14_refactoringgolf/hole2/...

golf3:
	go test -v ./14_refactoringgolf/hole3/...

golf4:
	go test -v ./14_refactoringgolf/hole4/...

golf5:
	go test -v ./14_refactoringgolf/hole5/...

golf6:
	go test -v ./14_refactoringgolf/hole6/...

golf7:
	go test -v ./14_refactoringgolf/hole7/...

golf8:
	go test -v ./14_refactoringgolf/hole8/...

golf9:
	go test -v ./14_refactoringgolf/hole9/...

golf10:
	go test -v ./14_refactoringgolf/hole10/...

golf11:
	go test -v ./14_refactoringgolf/hole11/...

golf12:
	go test -v ./14_refactoringgolf/hole12/...

golf13:
	go test -v ./14_refactoringgolf/hole13/...
