...
Given a positive integer, return a slice of its prime factors in ascending order. A prime factor is a prime number that divides the input number without leaving a remainder.
...
2. Return a slice of prime factors
3. Follow the TDD cycle: Red → Green → Refactor

## Edge Cases to Consider

- Input of 1 should return an empty slice
