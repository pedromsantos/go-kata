...
func (b *Board) playerAt(coordinate Coordinate) Player {
	return b.findTile(NewTile(noPlayer, coordinate)).Player()
}
...
func (b *Board) hasSamePlayer(coordinate, otherCoordinate Coordinate) bool {
	return b.findTile(NewTile(noPlayer, coordinate)).HasSamePlayerAs(b.findTile(NewTile(noPlayer, otherCoordinate)))
}
